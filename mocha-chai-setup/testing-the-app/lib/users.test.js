...
describe('users', () => {
  ...
  context('create user', () => {
    ...
    it('shoul reject invalid args', async () => {
    ...
    it('should call mailer with email', () => {
  ...
  context('update user', () => {
    ...
    //   await expect(users.update(123, {age: 53})).to.eventually.be.rejectedWith('fake')
    // })
  })
